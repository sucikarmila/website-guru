...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $query = "INSERT INTO guru (nama) VALUES (?)";
        $stmt = mysqli_prepare($koneksi, $query);
        mysqli_stmt_bind_param($stmt, "s", $nama);

        if (mysqli_stmt_execute($stmt)) {
            header("Location: kelola_guru.php?success=Data guru berhasil ditambahkan");
            exit;
        } else {
            $errors[] = "Gagal menambahkan data guru: " . mysqli_error($koneksi);
        }
    }
}
?>
...
<body>
    <div class="container">
        ...
        <form action="tambah_guru.php" method="POST">
            ...
            <input type="text" name="nama" id="nama" class="input" value="<?php echo htmlspecialchars($nama); ?>" required>
